...
class WCMCA_CheckoutPage
{
	public function __construct()
	{
		...
		add_action('woocommerce_before_checkout_billing_form', array(&$this, 'add_billing_address_select_menu')); //---- BUG FIXED IN FUNCTION
	...
	function add_billing_address_select_menu($checkout)
	{
		...
		if(!get_current_user_id())
			return;
		//$wcmca_html_helper->render_address_select_menu(); //  hide because incorrect show form on checkout form billing adress dropdown select
	}
