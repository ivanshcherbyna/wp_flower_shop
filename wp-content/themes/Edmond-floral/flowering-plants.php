<?php
/* Template Name: Flowering plants */
...
//////////////////
        ...
        echo '<div class="catalog-wrap catalog-items-wrap">';


            echo "<div class='grid '>";
            echo "<div class='grid-sizer '></div>";

            foreach ($products_of_tag as $product) {
                ...
                ?>
                <a href="<?php echo $product_url; ?>" class="grid-item">
